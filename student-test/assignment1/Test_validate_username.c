...
void test_validate_my_username()
{
     ...
     */
    const char * first = my_username();
    char * second = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(first, second, "failed");
    TEST_ASSERT_TRUE_MESSAGE( true, "AEDS students, please fix me :)!");
}
